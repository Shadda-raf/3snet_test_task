...
export class EventCalendarEnPage{
    ...
    this.page = page;
    this.languageSwitcher = page.locator('dropdown', {hasText: 'EN'})
    this.topicSelector = page.locator('.checkselect', {hasText: 'Select a topic'});
    this.countrySelector = page.locator('.checkselect', {hasText: 'All countries'});
    this.widthField = page.locator('input[name="width"]');
    this.widthRangeInput = page.locator('#width-range');
    this.widthContainerCheckbox = page.locator('a', {hasText: 'the entire width of the container'});
    this.heightField = page.locator('input[name="height"]');
    this.heightRangeInput = page.locator('#height-ran[]ge');
    this.heightContainerCheckbox = page.locator('a', {hasText: 'to the full height of the block'});
   this.blueThemeRb = page.locator('input[type="radio"][value="blue"]');
    ...
    this.generatePreviewBtn = page.locator('button', {hasText: 'Generate preview'});
    ...
    async goto() {
        await this.page.goto('https://dev.3snet.info/en/eventswidget/');
    }
